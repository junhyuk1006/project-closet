    ...
    <div>
      ...
      >
        <Form>
          ...
          <Row className="align-items-center mb-3">
            <Col xs={12} md={6} lg={4}>
              <Form.Group controlId="stockRange">
                ...
                <div className="d-flex align-items-center">
                  ...
                  <Form.Control
                    type="number"
                    name="minCount"
                    value={searchParams.minCount}
                    className="me-2"
                    placeholder="최소 재고"
                    onChange={(e) => {
                      updateSearchParams('minCount', e.target.value);
                    }}
                  />
                  <Form.Control
                    type="number"
                    name="maxCount"
                    value={searchParams.maxCount}
                    placeholder="최대 재고"
                    onChange={(e) => {
                      updateSearchParams('maxCount', e.target.value);
                    }}
                  />
                </div>
              </Form.Group>
