...
public interface BoardRepository extends JpaRepository<Board, Long> {
    ...
    // 게시글 목록 조회: 닉네임 포함
    @Query("SELECT new com.project.dto.BoardDTO(b.id, b.boardTitle, b.boardContent, b.boardImage, b.createdAt, u.nickname) " +
    ...
    @Query("SELECT new com.project.dto.BoardDTO(b.id, b.boardTitle, b.boardContent, b.boardImage, b.createdAt, u.nickname) " +
            "FROM Board b JOIN b.user u " +
            "WHERE b.id = :id")
    BoardDTO findBoardDetailWithUserById(@Param("id") Long id);
