...
@Repository
public interface AdminItemDetailRepository extends JpaRepository<ItemDetail, Long> {

    @Query("SELECT new com.project.dto.AdminItemDetailDTO(" +
    ...
    Page<AdminItemDetailDTO> findItemDetail(Pageable pageable,
